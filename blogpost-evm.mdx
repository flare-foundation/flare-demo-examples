...
The `attestatationType` is for the evm attestation is hex encoding of `hexEncode("EVMTransaction")`
...
{/* <!-- This is good for future examples, but to much time consuming to do now --><!-- #### ERC20 payment --> */}
